...
/**
 * Annotation to mark a method to be a listener of before persisting flow.
 * 
 ...
 * 
 *	&#64;FlowPersisterBeforePersistEvent(priority = 10)
 *	public void onBeforePersist(IFlowCarter&lt;?&gt;> flowCarter) {
 *		... do something ...
 *	}
 *
...
public @interface FlowPersisterBeforePersistEvent {
