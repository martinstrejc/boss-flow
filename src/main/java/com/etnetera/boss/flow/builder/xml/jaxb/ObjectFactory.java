 ...
 * generated in the com.etnetera.boss.flow.builder.xml.jaxb package. 
...
public class ObjectFactory {
    ...
    private final static QName _FlowDescriptor_QNAME = new QName("http://www.etnetera.com/boss/flow/xmlModel", "flowDescriptor");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.etnetera.boss.flow.builder.xml.jaxb
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.etnetera.com/boss/flow/xmlModel", name = "flowDescriptor")
