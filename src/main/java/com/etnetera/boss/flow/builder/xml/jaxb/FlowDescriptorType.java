 ...
 *           &lt;element name="state" type="{http://www.etnetera.com/boss/flow/xmlModel}StateType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="realState" type="{http://www.etnetera.com/boss/flow/xmlModel}RealStateType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="viewState" type="{http://www.etnetera.com/boss/flow/xmlModel}ViewStateType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="virtualState" type="{http://www.etnetera.com/boss/flow/xmlModel}VirtualStateType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="joinState" type="{http://www.etnetera.com/boss/flow/xmlModel}JoinStateType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="conditionState" type="{http://www.etnetera.com/boss/flow/xmlModel}ConditionStateType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="switchState" type="{http://www.etnetera.com/boss/flow/xmlModel}SwitchStateType" maxOccurs="unbounded" minOccurs="0"/>
 *           &lt;element name="transition" type="{http://www.etnetera.com/boss/flow/xmlModel}TransitionType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
