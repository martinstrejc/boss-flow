...
/**
 * Annotation to mark a method to be a listener of restoring flow.
 * 
 ...
 * 
 *	&#64;FlowPersisterRestoreEvent(priority = 10)
 *	public void onRestore(IFlowCarter&lt;?&gt;> flowCarter) {
 *		... do something ...
 *	}
 *
...
public @interface FlowPersisterRestoreEvent {
